      ...
      <section className="relative min-h-screen flex flex-col justify-center items-center pt-20 pb-24 px-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center flex-1 flex flex-col justify-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            ...
            <a href="https://www.google.com" className="bg-white dark:bg-slate-800 text-indigo-600 dark:text-indigo-400 border-2 border-indigo-600 dark:border-indigo-500 px-8 py-4 rounded-full font-semibold hover:bg-indigo-50 dark:hover:bg-slate-700 transition-all"></a>
